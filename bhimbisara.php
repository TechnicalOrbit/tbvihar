      ...
      <div class="container">
        <div class="page-heading">
          <div class='breadcrumb-sub-title'>
            <h1 class="wow fadeInUp" data-wow-delay=".3s">Story of King Bimbisara </h1>
          </div>
          <ul class="page-list">
            <li>
            ...
            <li>
              <span>Story of King Bimbisara </span>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="e-con-inner">
          <div class="text-black fs-4 my-2 p-2 story">
            <div class=" p-5 mb-2" style="background-color: #faf3e1;">
              <h1>The Story of King Bimbisara</h1><br>
              <h2>Story: How Bimbisara Became a True Follower of Buddha</h2>
              <p>More than 2,500 years ago, in the ancient kingdom of Magadha, ruled a wise and powerful king named Bimbisara. He was admired for his intelligence, justice, and peaceful rule. But despite having wealth, fame, and power, there was still a question in his heart:
              <div>
                <q>
                  What is the true purpose of life?
                  Why do humans suffer even when they have everything?
                </q>
              </div>
              </p>

              <h2>The First Meeting</h2>
              <p>One peaceful morning, when the king was only around 25 years old, he was riding on the roads near the foothills of the Gijjhakuta (Vulture's Peak). Suddenly, he saw a calm and radiant young monk walking gently with his bowl.
                The king stopped.
                The monk's face was shining with peace—calm, fearless, free from desire.
                There was something extraordinary about him.
                Bimbisara walked toward him and asked:
                “You look like a prince, yet you walk like a monk. Who are you?”
                The monk raised his eyes gently and replied:
                “I am Siddhartha Gautama of the Shakya clan.
                I have renounced kingdom and luxury in search of the highest truth —
                the end of suffering.”
                King Bimbisara was astonished. This was no ordinary monk — this man had the nobility of a king and the heart of a saint.
              </p>


              <h2>The King's Offer</h2>
              <p>Impressed by Buddha's presence, the king made an offer:

                “If you do not find what you seek, return.
                My kingdom and throne will be waiting for you.”
                But Siddhartha smiled and said:
                “I seek something greater than a kingdom —
                the liberation of all beings.”
                The king bowed in respect.
              </p>

              <h2>The Return — After Enlightenment</h2>
              <div>
                Years passed.
                One day, news reached the palace:
                “The ascetic Siddhartha has become the Buddha — the Enlightened One.”
                King Bimbisara immediately traveled to Bodh Gaya and later to Rajagriha, where Buddha was teaching his first disciples.
                When he met the Buddha again, Bimbisara bowed and said:
                “You kept your promise. You have found the truth.”
                His heart was filled with faith, not because he was ordered, but because he experienced Buddha's wisdom and compassion.
              </div>

              <h2>Why He Chose Buddha's Path</h2>
              King Bimbisara followed Buddha because:
              <ul>
                <li>Buddha did not demand worship — he taught understanding.</li>
                <li> He did not offer heaven — he offered inner peace.</li>
                <li> He spoke not like a priest or a ruler — but like one who knew the truth by experience.</li>
              </ul>
              <h2>Buddha's teachings of:</h2>
              <ul>
                <li>Dhamma (Universal Truth)</li>
                <li>Compassion toward all living beings</li>
                <li> He promoted Dhamma (righteous living) </li>
                <li> The Noble Eightfold Path </li>
                <li> Freedom from greed, anger, and ignorance </li>
              </ul>
              <p>
                Bimbisara realized:<br>
                True greatness is not power over others —
                but mastery over one's own mind.
              </p>
              <h2>The Greatest Gift</h2>
              <p>To support Buddha’s mission, King Bimbisara donated the beautiful Venuvana Bamboo Grove, making it the first monastery for monks.

                It became a sacred place where:
              <ul>
                <li>
                  Buddha meditated
                </li>
              ...
              <h2>The King's Transformation</h2>
              <ul>
                <li>
