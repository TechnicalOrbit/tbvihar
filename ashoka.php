      ...
      <div class="container">
        <div class="page-heading">
          <div class='breadcrumb-sub-title'>
            <h1 class="wow fadeInUp" data-wow-delay=".3s">Story of King Ashoka </h1>
          </div>
          <ul class="page-list">
            <li>
            ...
            <li>
              <span>Story of King Ashoka</span>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div data-elementor-type="wp-page" data-elementor-id="4186" class="elementor elementor-4186" data-elementor-post-type="page">
      <div class="elementor-element elementor-element-524b41f e-flex e-con-boxed e-con e-parent" data-id="524b41f" data-element_type="container">
        <div class="e-con-inner">
          <div class="text-black fs-4 my-2 p-2 story">
            <div class="p-5 mb-2" style="background-color: #faf3e1;">
              <h1>Story of King Ashoka</h1><br>
              <h2>Story: How Ashoka Became a True Follower of Buddha</h2>
              <p>More than 2,300 years ago, India was ruled by a powerful and ambitious prince named Ashoka, the grandson of Chandragupta Maurya. Ashoka was brave, clever, and fierce. From a young age, he wanted to become the strongest emperor the world had ever seen.
                When he finally became king in 268 BCE, he decided to expand his empire across all of India. His armies marched from region to region, defeating many kingdoms. But there was one land that changed his life forever — Kalinga.
              </p>

              <h2>The Turning Point — The Kalinga War</h2>
              <p>It was the year 261 BCE.
                Ashoka launched a massive war against Kalinga. The battle was one of the bloodiest in Indian history.

                When the war ended, Ashoka walked across the battlefield.
                He saw:
              <ul>
                <li>Thousands of dead soldiers</li>
                <li>Families crying</li>
                <li>Children without parents</li>
                <li>Destroyed homes</li>
              </ul>
              For the first time, the mighty emperor felt shock, guilt, and deep pain.
              Ashoka sat down quietly on the battlefield and whispered:
              “What have I done?
              Victory achieved through sorrow is not victory.
              There must be a different path…”
              That moment became the turning point of his life.</p>

              <h2>Ashoka Meets the Path of Buddha</h2>
              <p>After the war, Ashoka began searching for peace. He met a Buddhist monk named Nigrodha, a calm and wise teacher.
                Ashoka asked him:
                “How can I find peace when my hands are stained with blood?”
                Nigrodha simply said:
                “Peace comes when we end suffering —
                in ourselves and in others.”
                These words touched Ashoka’s heart.
                Nigrodha told him the teachings of Gautam Buddha:
              <ul>
                <li>Life has suffering</li>
                <li> cause of suffering is desire, anger, and ignorance</li>
                <li> comes from compassion and wisdom</li>
                <li>True victory is conquering one’s own mind</li>
              </ul>
              Slowly, Ashoka began to understand.
              In 260–258 BCE, Ashoka officially accepted Buddhism and started living according to Buddha’s principles.
              </p>

              <h2>Why Ashoka Chose Buddha’s Path</h2>
              <div>
                <h3>He was deeply affected by the suffering of Kalinga:</h3>
                <p>For the first time, he saw the reality of war.
                  This made him search for a more peaceful way of living.</p>
                <h3>Buddha’s teachings matched his inner need for peace:</h3>
                <p>The ideas of non-violence, compassion, forgiveness, and truth gave him the answer he had been looking for.</p>
                <h3>Buddha’s path offered a way to rule with kindness:</h3>
                <p>Ashoka realized that a king can rule more strongly with justice and love, rather than fear.</p>
                <h3>Buddhism helped him transform guilt into compassion:</h3>
                <p>Instead of being crushed by guilt, Ashoka used it to improve himself and the whole empire.</p>
              </div>

              <h2>Ashoka After Becoming a Follower of Buddha</h2>
              After embracing Buddhism, Ashoka changed completely:
              <ul>
                <li>He stopped wars</li>
                <li> planted trees, dug wells, and built rest houses</li>
                <li> He built 84,000 stupas and spread Buddha’s teachings</li>
                <li> He sent his children Mahinda and Sanghamitta to Sri Lanka to spread Buddhism</li>
                <li> He created the famous Ashoka Pillars, carved with teachings of morality and peace</li>
                <li> He promoted Dhamma (righteous living) </li>
              </ul>
              People started calling him “Dhamma Ashoka” — the King of Righteousness.
            </div>
          </div>
        </div>
